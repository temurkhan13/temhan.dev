...
If you'd rather have someone outside your team do the first audit so you have a baseline to compare against, that's literally the service I run — [Hire me →](../../hire.qmd) for $2.5-7.5k tiered audits, plus a free 30-min triage call if you're unsure which tier fits.
...
- **[Production-AI MCP Suite](https://temurah.gumroad.com/l/production-ai-mcp-suite)** — bundled 7-pack of MCPs + 35-pattern Field Reference PDF, $29.
- **[AI Production Discipline Framework](https://temurah.gumroad.com/l/ai-production-discipline-framework)** — Notion template with the full 14-pattern catalog plus the audit ritual, $19.
